...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 29 14:20:14 2023
...
class CanvasImage:
    ...
    def __init__(self, placeholder, path):
      ...
      #  self.texttt = self.canvas.create_text(0, 0, anchor='w', text=self.text, width=0)
    ...
    def motion(self,event):
        ...
        self.text='{}, {}'.format((x0)/self.__scale,y0/self.__scale)
      #  self.texttt.configure(text=self.text)
      #  print(self.text)
...
# filename = r'D:\Projects\2.Term2\Digital_Photogrammetry\project1\main\data\21_60_.png'  # place path to your image here
